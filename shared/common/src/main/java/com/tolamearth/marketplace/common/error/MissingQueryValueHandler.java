...
@Singleton
@Produces
public class MissingQueryValueHandler implements ExceptionHandler<UnsatisfiedQueryValueRouteException, HttpResponse> {

    @Override
    public HttpResponse handle(HttpRequest request, UnsatisfiedQueryValueRouteException exception) {

        HemErrorCode errorCode = HemErrorCode.MISSING_REQUIRED_FIELD;
        String message = errorCode.getMessage() + ": " + exception.getQueryParameterName();
